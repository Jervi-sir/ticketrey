...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100">
            ...
            <!-- Page Content -->
            <main>
                <h1 class="text-center py-3 text-purple-400 font-bold">All Offerss</h1>
                        ...
                        <tr class="@if($loop->iteration % 2 == 0)bg-blue-200 @endif">
                            <td class="border border-blue-500 px-4 py-2 text-blue-600 font-medium">
                                ...
                                <form action="{{ route('admin.confirmOffer', ['id'=>$offer->id]) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="rounded-md bg-green-300 text-white px-4 py-1 hover:bg-gray-800 ease-in-out duration-200  mx-auto">Verify</button>
                                </form>
                                @else
